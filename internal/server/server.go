...
//   - internal/tools  (the 17 Confluence tool handlers + safeHandler wrapper)
...
//     package self-contained (it owns the 17 tool names, the 17
//     descriptions, and the 17 handlers) while this package owns
